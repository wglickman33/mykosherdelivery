...
// Zone order: later zones overwrite for overlapping zips (e.g. 5Towns $5 over Queens/Nassau).
const ZONES = [
  {
  ...
  },
  {
    city: '5Towns',
    delivery_fee: 5.00,
    zips: ['11096', '11422', '11516', '11557', '11559', '11563', '11581', '11598']
  },
  {
    city: 'Nassau County',
    delivery_fee: 16.00,
  ...
  async up(queryInterface) {
    ...
    for (const zone of ZONES) {
      for (const zip of zone.zips) {
        zipToZone.set(zip, { city: zone.city, delivery_fee: zone.delivery_fee });
      }
    }

    const deliveryZones = [];
    for (const [zip, { city, delivery_fee }] of zipToZone) {
